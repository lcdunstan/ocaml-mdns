...
- When any request is received (includes probes)
  ...
  - If it does not match any record
    - Optional: if it matches a cached record (10.4)
      - Increment a request counter for the cache record (10.4)
      - If the counter is equal to 1 (10.4)
        - Start a 10-second timer (10.4)
      - When the 10-second timer expires (10.4)
        - If the counter is at least 2 (10.4)
          - Flush the cache record immediately (10.4)
