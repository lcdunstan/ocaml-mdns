...
(* OASIS_START *)
(* DO NOT EDIT (digest: 06690d08729f2c4238851e2ad0bdd4ee) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "not yet implemented";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mdns";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mdns-lwt-core";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Mdns_server"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mdns";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mdns_resolver_mirage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mdns";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "mdns_resolve.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\171\230&\161\201\157\155\156\166j!\216Bp\200\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
